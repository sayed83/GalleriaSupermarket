...
namespace GalleriaSupermarket.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    {
                        Session["OutletID"] = user.OutletID.ToString();
                        return RedirectToAction("Index", "GsmAdmin");
                    }                        
                    else
                    {
        ...
        public ActionResult UserProfile(ApplicationUser userInfo)
        {
            ...
            if(userData != null)
            {
                if(userInfo.UserImageUpload != null)
                {
                    ...
                    db.SaveChanges();
                    System.IO.File.Delete(Path.Combine(Server.MapPath("~/App_File/Staff_Img"), oldImg));
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                ModelState.AddModelError("", "You are not agree to terms and condition");
            }
            else
            {
                if (ModelState.IsValid)
                {
                    var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, UserType = "Customer", FullName = model.FullName, ImageUrl= "avatar5.png" };
